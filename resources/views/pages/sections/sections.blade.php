                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($sections as $list_Sections)
                                                                    @if ($list_Sections->grade_id == $Grade->id)
                                                                        <tr>
                                                                                <?php $i++; ?>
                                                                            <td>{{ $i }}</td>
                                                                            <td>{{ $list_Sections->Name_Section	 }}</td>
                                                                            <td>{{ $list_Sections->class->className }}</td>
                                                                            <td>
                                                                                @if (isset($list_Sections->Teachers))
                                                                                    @foreach ($list_Sections->Teachers as $item)
                                                                                        <option selected
                                                                                            value="{{ $item->id }}">
                                                                                            {{ $item->name }}
                                                                                        </option>
                                                                                ...
                                                                                <span
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <form
                                                                                            ...
                                                                                            <br>
                                                                                            {{-- edit the teacher selected --}}
                                                                                            <div class="col">
                                                                                                <label for="inputName"
                                                                                                       class="control-label">{{ trans('Teachers.teachers') }}</label>

                                                                                                       <div class="col">
                                                                                                        <label for="inputName" class="control-label">{{ trans('Teachers.teachers') }}</label>
...
{{--                                        <div class="col">--}}
{{--                                            <label for="inputName"--}}
{{--                                                   class="control-label">name {{ trans('Teachers.teachers') }}</label>--}}
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(data, function (key, value) {
                                        $('select[name="Class_id"]').append('<option value="' + value.id + '">' + value.className + '</option>');
                                    });
                                },
                            });
                        } else {
